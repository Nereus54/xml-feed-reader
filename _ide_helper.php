...
namespace App\Services\XmlParser\Facades { 
    ...
    class XmlParser {
        ...
        {
            return \App\Services\XmlParser\XmlParserService::loadFromUrl($url);
        }
        ...
        {
            return \App\Services\XmlParser\XmlParserService::parse();
        }
...
namespace  { 
    ...
    class XMLParser extends \App\Services\XmlParser\Facades\XmlParser {}
